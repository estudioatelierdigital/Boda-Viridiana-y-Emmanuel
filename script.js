...
const WEDDING_CONFIG = {
    ...
    */
    ...
    rsvpMessage:
        "Hola, confirmo mi asistencia a la boda de Viridiana y Emmanuel.",
...
function initRSVP(){
    ...
    if(!hasValidPhone){
        ...
        rsvpBtn.addEventListener("click", (event) => {
            ...
            alert("Plantilla de muestra: aquí se configura el WhatsApp del cliente.");
        });
